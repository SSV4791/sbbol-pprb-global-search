...
/**
 * Реализация сервиса проливки обновлений в Opensearch
 */
public class OpenSearchUpdaterServiceImpl implements OpenSearchUpdaterService {
    ...
    private final UpdaterQueriesIndexService queriesIndexService;
    ...
    protected final void execQuery(IndexQuery query) throws IOException {
